...
for (const entry of entries) {
  ...
  const styleModule = (await import(pathToFileURL(stylesPath).href)) as StyleModule
  ...
  const componentSourcePath = join(componentsDir, componentName, "src", componentSourceName)
